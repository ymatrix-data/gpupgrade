...
type Message_NextActions struct {
	NextActions *NextActions `protobuf:"bytes,4,opt,name=nextActions,proto3,oneof"`
}
...
func (*Message_NextActions) isMessage_Contents() {}
...
func (m *Message) GetNextActions() *NextActions {
	if x, ok := m.GetContents().(*Message_NextActions); ok {
...
type NextActions struct {
	...
	NextActions          string   `protobuf:"bytes,2,opt,name=nextActions,proto3" json:"nextActions,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *NextActions) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
var fileDescriptor_631e66a01873be02 = []byte{
	...
	,
}
