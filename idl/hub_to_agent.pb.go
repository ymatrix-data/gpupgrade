...
type RecoveryConfInfo struct {
	TargetPrimaryPort    int32    `protobuf:"varint,1,opt,name=TargetPrimaryPort,proto3" json:"TargetPrimaryPort,omitempty"`
	SourcePrimaryPort    int32    `protobuf:"varint,2,opt,name=SourcePrimaryPort,proto3" json:"SourcePrimaryPort,omitempty"`
	TargetMirrorDataDir  string   `protobuf:"bytes,3,opt,name=TargetMirrorDataDir,proto3" json:"TargetMirrorDataDir,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_9e73bb06acc917d8 = []byte{
	...
	,
}
